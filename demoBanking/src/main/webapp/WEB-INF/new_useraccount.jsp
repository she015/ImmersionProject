...
<body>
    ...
    <div class="container">
      ...
      <div class="divider"></div>
       <h2>UserName</h2>
      <form:input id="input-username"  type="text" path="userName" readonly="true"/>
     <h2>First Name</h2>
      <form:input id="input-username"  type="text" path="firstName" />
     <h2>Last Name</h2>
      <form:input id="input-username"  type="text" path="lastName" />
     <h2>Contact No</h2>
      <form:input id="input-contact" type="text" path="contactNo" />
      <h2>Total Balance</h2>
      <form:input id="input-contact" type="text" path="totalBal" />
