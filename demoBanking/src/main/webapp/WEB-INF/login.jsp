...
<div class="login">
    ...
    <form action="validate" method="post" modelAttribute="user">
    	<input type="text" name="userName" placeholder="Username" value="${user.userName}" required="required" />
        <input type="password" name="password" placeholder="Password" required="required" />
        <button type="submit" class="btn btn-primary btn-block btn-large">Login</button>
       </form>
 	<a href="/register" style="text-decoration: none;"><button type="submit" class="btn btn-primary btn-block btn-large">Register</button></a>
